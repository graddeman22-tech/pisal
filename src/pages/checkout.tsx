        ...
        <div className="lg:w-1/3">
          <div className="bg-card rounded-2xl border border-border p-6 shadow-sm sticky top-28">
            ...
            <div className="space-y-4 mb-6 max-h-64 overflow-y-auto pr-2">
              {cart.items.map(item => (
                <div key={item.id} className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded border bg-muted shrink-0 overflow-hidden"><img src={item.productImage} className="w-full h-full object-cover"/></div>
            ...
            <div className="border-t border-border pt-4 space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-muted-foreground">Subtotal</span><span className="font-medium">₹{cart.subtotal}</span></div>
